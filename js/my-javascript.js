...
function changeAboutColour(newColour) {
    var navbarColour = document.getElementById("navbar");
    navbarColour.style.backgroundColor = newColour; //Javascript implementation on CSS code
}

function changeEventColour(newColour) {
    var navbarColour = document.getElementById("navbar");
    navbarColour.style.backgroundColor = newColour; //Javascript implementation on CSS code
}

function changeContactColour(newColour) {
    var navbarColour = document.getElementById("navbar");
    navbarColour.style.backgroundColor = newColour; //Javascript implementation on CSS code
}

function changeMazeColour(newColour) {
    var navbarColour = document.getElementById("navbar");
    navbarColour.style.backgroundColor = newColour; //Javascript implementation on CSS code
}
